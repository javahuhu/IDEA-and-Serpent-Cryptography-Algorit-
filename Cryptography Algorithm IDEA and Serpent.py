...
def encrypt():
    ...
    if os.path.isfile(input_file):
        ...
        # Concatenate the success message with the private key
        success_message = f"File Encrypted successfully. Private Key: {private_key()}"
        messagebox.showinfo("Success", private_key)
...
def idea():
    ...
    key_Label = tk.Label(IDEA, text="Key", bg='#8FD7C7', font=button_font, fg='#253226')
    ...
    encrypt_button = tk.Button(IDEA, text="Encrypt", command=encrypt,  bg='#B8DAFF',  activebackground='white',)
    encrypt_button.grid(row=11, column=0, columnspan=100, padx=70, pady=25, sticky='w')
    
    Back_button = tk.Button(IDEA, text="Back", command=lambda: [IDEA.destroy(), Back()],  bg='#B8DAFF', activebackground='white',)
    Back_button.grid(row=11, column=1, columnspan=100, padx=200, pady=27, sticky='w')
...
def serpents():
    ...
    encrypt_button.grid(row=11, column=0, columnspan=60, padx=50, pady=25, sticky='w')

    decrypt_button = tk.Button(serpent, text="Decrypt", command=decrypt,  bg='#B8DAFF',   activebackground='white',)
    decrypt_button.grid(row=11, column=1, columnspan=60, padx=137.5, pady=25, sticky='w')

    Exit_button = tk.Button(serpent, text="Back", command=lambda: [serpent.destroy(), Back()],  bg='#B8DAFF',  activebackground='white',)
    Exit_button.grid(row=11, column=1, columnspan=100, padx=227, pady=27, sticky='w')
